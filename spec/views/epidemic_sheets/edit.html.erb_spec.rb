...
RSpec.describe "epidemic_sheets/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit epidemic_sheet form" do
    render

    assert_select "form[action=?][method=?]", epidemic_sheet_path(@epidemic_sheet), "post" do
