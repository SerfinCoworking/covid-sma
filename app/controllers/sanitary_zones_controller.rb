class SanitaryZonesController < ApplicationController
  before_action :set_sanitary_zone, only: [:show, :new, :edit, :create, :update, :destroy, :delete]
  ...
  def index
    ...
    @sanitary_zones = @filterrific.find.page(params[:page]).per_page(15)
  end
  ...
  def destroy
    ...
    respond_to do |format|
      flash.now[:success] = "El sanitary_zone "+sanitary_zone+" se ha eliminado correctamente."
      format.js
    end
  end
